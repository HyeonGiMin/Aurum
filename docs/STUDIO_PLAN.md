...
| Phase | 내용 | 상태 |
|---|---|---|
| **P1** | 점진 fetch 그리드, 문장 분리기(달러쿼팅), F9 커서 문장 실행, 취소 | ✅ 완료 |
| **P2** | 에디터 하이라이팅, F5 스크립트, 히스토리, 바인드 변수, 자동완성, Find | ✅ 완료 |
| **P2.5** | 공유 세션 모델 + Private Tab (Golden §3) | ✅ 완료 |
| **P3** | 접속 저장/로그인 UX, Object Browser, Describe(Ctrl+D 포함) | ✅ 완료 |
| **P4** | 커밋 제어, Export 확장(TSV/INSERT/COPY), 옵션 다이얼로그, 워크스페이스 | ✅ 완료 |
| **P5** | 마감: 단축키 점검, 아이콘/툴바, 대용량 성능 | 진행 중 (10만행 성능 미검증) |
| **P6** | Favorites, Run and Edit(그리드 편집), Print | 미착수 |

> 최신 진행 상황과 다음 작업은 [STATUS.md](STATUS.md) 를 본다.
